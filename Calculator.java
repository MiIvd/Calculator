...
public class Calculator extends JFrame {
	...
	/**
	 * Sets the look, feel, and dimensions of the Calculator
	 */
	...
	/**
	 * Gets the set look and feel from the UI manager
	 */
	...
	/**
	 * Sets the spacing in between the border and the layout as well as its color
	 * @return JPanel
	 */
	...
	/**
	 * Adds the buttons to the calculator, setting the numbers and operators. Sets the font size and coloring of the buttons.
	 * @param panel
	 */
	...
	/**
	 * Handles when a user clicks on one of the calculator buttons and returns what the button symbolizes.
	 */
	
	public class ButtonHandler implements ActionListener {      
		/**
		 * When equals button is pressed, input is evaluated and returned back into the calculator.
		 */
